let wasm_bindgen = (function(exports) {
     ...
     * @returns {boolean}
     */
    function check_dollar_variables(input, rules_json) {
    ...
    exports.check_dollar_variables = check_dollar_variables;
     ...
     * @returns {any}
     */
    function convert_agent(input_json, rules_json) {
        try {
    ...
    exports.convert_agent = convert_agent;
     ...
     * @returns {number}
     */
    function count_actions(nga_json) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    ...
    exports.count_actions = count_actions;
     ...
     * @returns {number}
     */
    function count_topics(nga_json) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(nga_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
    ...
    exports.count_topics = count_topics;
     ...
     * @param {string} input_json
     * @param {string} output_yaml
     * @param {string} metadata_json
     * @returns {any}
     */
    function generate_report_data(input_json, output_yaml, metadata_json) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(input_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(output_yaml, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(metadata_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len2 = WASM_VECTOR_LEN;
            wasm.generate_report_data(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    exports.generate_report_data = generate_report_data;
     ...
     * @returns {string}
     */
    function get_alert_message(rules_json) {
        let deferred2_0;
        let deferred2_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    ...
    exports.get_alert_message = get_alert_message;
     ...
     * @returns {string}
     */
    function get_status_suffix(rules_json) {
        let deferred2_0;
        let deferred2_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
